...
LOG_CHANNEL_ID = 1521585275229442178import discord
from discord.ext import commands
import os
import asyncio
import time
    ...
    if pinged_roles:
        ...
        if message.channel.id == SZUKAM_CHANNEL:
            ...
            try:
                ...
                # Sformatowany, powiększony tekst statusu
                if max_players > 0:
                ...
                # Usuwamy frazę "PING" z nazwy roli, jeśli znajduje się na końcu
                ...
                # Zmieniono ikonkę kanału na słuchawki 🎧
